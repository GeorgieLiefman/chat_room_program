"""This program is the server code for a multi-user online chat room.
...
add them and their chosen nickname to two seperate lists. The host then receives messages from
